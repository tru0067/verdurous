...
function! s:HL(group, fg, bg, attrs, ...)
    ...
    if a:fg ==? "NONE"
        ...
        let l:histr = l:histr . " ctermfg=" . a:fg . " guifg=" . g:palette[a:fg]
    endif
    if a:bg ==? "NONE"
        let l:histr = l:histr . " ctermbg=NONE guibg=NONE"
    else
        let l:histr = l:histr . " ctermbg=" . a:bg . " guibg=" . g:palette[a:bg]
    endif
...
call s:HL("SpellBad",     'NONE', 'NONE', 'undercurl', 'guisp=' . g:palette[1])
call s:HL("SpellCap",     'NONE', 'NONE', 'undercurl', 'guisp=' . g:palette[4])
call s:HL("SpellLocal",   'NONE', 'NONE', 'undercurl', 'guisp=' . g:palette[6])
call s:HL("SpellRare",    'NONE', 'NONE', 'undercurl', 'guisp=' . g:palette[5])
